...
public class AdminDisp {
    ...
    public void agregarDisposp(Casa casa,int areaId,int habiatacionId,Dispositivo dispositivo){
        casa.getArea(areaId).getHabitacion(habiatacionId).addDevice(dispositivo);
